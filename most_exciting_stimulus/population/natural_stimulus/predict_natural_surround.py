...
def get_most_exciting_natural_center(
    ...
    # find the most exciting stimulus
    ...
    assert df.trial.nunique() == 1 and df.frame.nunique() == 1
...
class NaturalFullFieldDataset(Dataset):
    def __init__(
        ...
        self.static_center = args.static_center
        ...
        self.surround_videos, self.trial_ids = videos, trial_ids
        self.clip_ids = self.get_clip_ids(videos=videos, trial_ids=trial_ids)
        # load most-exciting natural center for the population
        self.center_video = get_most_exciting_natural_center(
            data_dir=args.data_dir,
            output_dir=args.output_dir,
            mouse_id=mouse_id,
            static=self.static_center,
        )
...
def get_clip(
    ...
    stimulus_type = "static" if args.static_surround else "dynamic"
